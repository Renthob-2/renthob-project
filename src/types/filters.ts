...
export const AMENITIES = [
  { value: "fenced", label: "Fenced Compound" },
  { value: "security_gate", label: "Gated Compound" },
  { value: "floored_compound", label: "Floored Compound" },
  { value: "borehole", label: "Running Water (Borehole)" },
  ...
  { value: "ensuite", label: "Fully Ensuite" },
